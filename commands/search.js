...
module.exports = {
  info: {
    name: "search",
    description: "Para buscar canciones: D",
    usage: "<song_name>",
    aliases: ["sc"],
  },
...
stream.on('error', function(er)  {
    ...
    queue.connection.on("disconnect", () => message.client.queue.delete(message.guild.id));
      ...
      let thing = new MessageEmbed()
      .setAuthor("¡Comenzó a reproducir música!", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
      .setThumbnail(song.img)
      .setColor("BLUE")
